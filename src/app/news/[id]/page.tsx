...
//     const posts: newTypes[] = await fetch('https://news-api-next-js-kappa.vercel.app/api/news').then((res) =>
//       res.json()
//     )
...
const NewsDetails = async ({ params }: { params: { id: string } }) => {
    ...
    // console.log('detilas', post)

    return (
        <section className='py-16'>
            <AllPageBanner headingTitle="News Details Page" />
            {/* details part card */}
